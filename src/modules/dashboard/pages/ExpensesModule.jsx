        ...
        <div className="max-w-7xl mx-auto space-y-8 animate-fade-in p-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-500 mt-1 font-medium">Track plant, fleet, and administrative costs.</p>
                </div>
                <Button onClick={() => setShowAddModal(true)} className="bg-rose-600 hover:bg-rose-700 text-white font-bold px-6 shadow-lg shadow-rose-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="bg-white border-l-4 border-l-rose-500 shadow-md">
            ...
            <Card className="border-none shadow-xl bg-white overflow-hidden rounded-2xl">
                <CardHeader className="bg-slate-50 border-b border-slate-100">
                    <CardTitle className="text-lg font-bold text-slate-700">Expense Journal</CardTitle>
                </CardHeader>
                        ...
                        <TableBody>
                            {expenses.map((expense) => (
                                <TableRow key={expense.id} className="hover:bg-slate-50">
                                    ...
                                    <TableCell>
                                        <Badge variant="secondary" className="font-bold text-slate-600 bg-slate-100 flex w-fit gap-2">
                        ...
                        <CardContent className="pt-6">
                            <form onSubmit={handleAddExpense} className="space-y-4">
                                ...
                                <div className="flex gap-3 mt-6">
                                    ...
                                    <Button type="submit" className="flex-1 bg-rose-600 hover:bg-rose-700 text-white font-bold">Confirm Expense</Button>
                                </div>
                            </form>
                        </CardContent>
                    </Card>
